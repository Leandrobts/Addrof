// js/script3/testArrayBufferVictimCrash.mjs (v112 - Corrigido ReferenceError de JSC_OFFSETS)
// =======================================================================================
// LOG DE ALTERAÇÕES:
// - Corrigido um erro crítico onde JSC_OFFSETS não estava definido, causando uma falha
//   imediata na configuração das primitivas. A importação de 'config.mjs' foi adicionada.
// - Mantém a estratégia de "Uncaged Array" da v111.
// =======================================================================================

import { logS3 } from './s3_utils.mjs';
import { AdvancedInt64, toHex } from '../utils.mjs';
// #FIX: Adicionada a importação de JSC_OFFSETS de config.mjs
...
export const FNAME_MODULE_FINAL = "Uncaged_Hybrid_v112_ArrayTC";
...
async function runWebKitBaseLeakTest_Uncaged(addrof_primitive, arb_read_primitive) {
    const FNAME_LEAK_TEST = "WebKitBaseLeakTest_v112_Uncaged";
...
export async function runFinalUnifiedTest() {
    ...
    logS3(`--- Iniciando ${FNAME_CURRENT_TEST_BASE}: Teste com Primitivas Híbridas (v112) ---`, "test");
