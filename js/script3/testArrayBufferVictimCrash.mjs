// js/script3/testArrayBufferVictimCrash.mjs (v82_AdvancedGetterLeak - R40)
...
function advInt64LessThanOrEqual(a, b) { /* ... (como na R38/R32) ... */
...
export async function executeTypedArrayVictimAddrofTest_AdvancedGetterLeak_R40() { 
    ...
    let best_result_for_runner = { /* ... (como na R38/R32) ... */
    ...
    for (const current_oob_value of OOB_WRITE_VALUES_V82) {
        ...
        function toJSON_TA_Probe_Iter_Closure_R40() { /* ... (lógica da sonda como na R38/R32, apenas atualizando logs para R40) ... */ 
            ...
            if (heisenbugConfirmedThisIter) { 
                try {
                    ...
                    for (let current_scan_addr = new AdvancedInt64(SCAN_HEAP_START_ADDRESS_R40.low(), SCAN_HEAP_START_ADDRESS_R40.high()); 
                         ...
                         current_scan_addr = current_scan_addr.add(SCAN_STEP_R40)) { // .add() usará a versão corrigida
