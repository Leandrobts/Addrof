...
// ESTE ARQUIVO ESTÁ COMPATÍVEL COM A VERSÃO FOCADA DO testArrayBufferVictimCrash.mjs
import { logS3, PAUSE_S3, MEDIUM_PAUSE_S3 } from './s3_utils.mjs';
import { getOutputAdvancedS3, getRunBtnAdvancedS3 } from '../dom_elements.mjs';
import {
    executeTypedArrayVictimAddrofAndWebKitLeak_R43,
    FNAME_MODULE_TYPEDARRAY_ADDROF_V82_AGL_R43_WEBKIT // Importa o nome do módulo do arquivo de teste
...
async function runHeisenbugReproStrategy_TypedArrayVictim_R43() {
    ...
    if (result.errorOccurred) {
        ...
        // Usa result.oob_value_of_best_result, que é o que a versão focada do teste retorna
        ...
        // Usa result.heisenbug_on_M2_in_best_result
        ...
        if (result.iteration_results_summary && result.iteration_results_summary.length > 0) {
            ...
            result.iteration_results_summary.forEach((iter_sum, index) => {
                ...
                // O 'iter_sum.oob_value' está correto aqui, pois o teste focado ainda o preenche assim para o sumário da iteração.
...
export async function runAllAdvancedTestsS3() {
    ...
    if (document.title.includes(FNAME_MODULE_TYPEDARRAY_ADDROF_V82_AGL_R43_WEBKIT) &&
        ...
        document.title = `${FNAME_MODULE_TYPEDARRAY_ADDROF_V82_AGL_R43_WEBKIT}_R43L_Done`;
    }
}
