// js/script3/runAllAdvancedTestsS3.mjs (Runner para R61 - Call Frame Walk)
import { logS3, PAUSE_S3, MEDIUM_PAUSE_S3 } from './s3_utils.mjs';
import { getOutputAdvancedS3, getRunBtnAdvancedS3 } from '../dom_elements.mjs';
import {
    executeTypedArrayVictimAddrofAndWebKitLeak_R61 as executeTest,
    FNAME_MODULE
} from './testArrayBufferVictimCrash.mjs';

async function runStrategy_CallFrameWalk_R61() {
    const FNAME_RUNNER = "runStrategy_CallFrameWalk_R61";
    ...
    if (!result) {
        ...
        logS3(`  RUNNER R61(CallFrameWalk): Objeto de resultado inválido ou nulo.`, "critical", FNAME_RUNNER);
        return;
    }
...
export async function runAllAdvancedTestsS3() {
    ...
    logS3(`==== INICIANDO Script 3 R61_CallFrameWalk (${FNAME_ORCHESTRATOR}) ... ====`, 'test', FNAME_ORCHESTRATOR);
    
    await runStrategy_CallFrameWalk_R61();
    
    logS3(`\n==== Script 3 R61_CallFrameWalk (${FNAME_ORCHESTRATOR}) CONCLUÍDO ====`, 'test', FNAME_ORCHESTRATOR);
